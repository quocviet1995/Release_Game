...
Window_TitleCommand.prototype.initialize = function(rect) {
    ...
    const height = this.fittingHeight(4); // Đặt chiều cao cho 4 hàng
    const x = (Graphics.width - width) / 2;
    const y = (Graphics.height - height) / 1.3;
    Window_Command.prototype.initialize.call(this, new Rectangle(x, y, width, height));
    //Window_Command.prototype.initialize.call(this, new Rectangle(285, 320, width, height));
    //Window_Command.prototype.initialize.call(this, rect);
    this.openness = 0;
    this.selectLast();
};
...
Window_TitleCommand.prototype.windowWidth = function() {
    return 240; // Đặt chiều rộng của cửa sổ lệnh
};
